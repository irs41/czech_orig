...
_labelSearch_ [l=cs] {Vyhledat}  # opink 7.4.2011 - sl.                   

# Dublin Core Metadata Element Set, Version 1.1
_textTitle_ [l=cs] {Názvu}                        # opink 7.4.2011 - sl. 
_labelTitle_ [l=cs] {Tituly}                      # opink 7.4.2011 - sl.  
_textCreator_ [l=cs] {Autor}                      # opink 7.4.2011 - sl. 
_labelCreator_ [l=cs] {Autoři}                    # opink 7.4.2011 - sl. 
_textSubject_ [l=cs] {Předmětu}                   # opink 7.4.2011 - sl. 
_labelSubject_ [l=cs] {Klíčová slova}             # opink 7.4.2011 - sl. 
_textDescription_ [l=cs] {Popis}                  # opink 7.4.2011 - sl. 
_labelDescription_ [l=cs] {Popis}                 # opink 7.4.2011 - sl.
_textPublisher_ [l=cs] {Vydavatel}                # opink 7.4.2011 - sl. 
_labelPublisher_ [l=cs] {Vydavatelé}              # opink 7.4.2011 - sl. 
_textContributor_ [l=cs] {Přispěvatel}            # opink 7.4.2011 - sl. 
_labelContributor_ [l=cs] {Přispěvatelé}          # opink 7.4.2011 - sl. 
_textDate_ [l=cs] {Datum}                         # opink 7.4.2011 - sl.
_labelDate_ [l=cs] {Datumy}                       # opink 7.4.2011 - sl. 
_textType_ [l=cs]  {Typ}                          # opink 7.4.2011 - sl. 
_labelType_ [l=cs] {Typy}                         # opink 7.4.2011 - sl. 
_textFormat_ [l=cs] {Formát}                      # opink 7.4.2011 - sl. 
_labelFormat_ [l=cs] {Formáty}                    # opink 7.4.2011 - sl. 
_textIdentifier_ [l=cs] {identifikátor}           # opink 7.4.2011 - sl. 
_labelIdentifier_ [l=cs] {Identifikátor}          # opink 7.4.2011 - sl. 
_textSource_ [l=cs] {Název souboru}               # opink 7.4.2011 - sl. 
_labelSource_ [l=cs] {Názvy souborů}              # opink 7.4.2011 - sl. 
_textLanguage_ [l=cs] {Jazyk}                     # opink 7.4.2011 - sl. 
_labelLanguage_ [l=cs] {Jazyky}                   # opink 7.4.2011 - sl. 
_textRelation_ [l=cs] {Vztah}                     # opink 7.4.2011 - sl. 
_labelRelation_ [l=cs] {Vztahy}                   # opink 7.4.2011 - sl. 
_textCoverage_ [l=cs] {Pokrytí}                   # opink 7.4.2011 - sl. 
_labelCoverage_ [l=cs] {Pokrytí}                  # opink 7.4.2011 - sl. 
_textRights_ [l=cs] {Práva}                       # opink 7.4.2011 - sl.
_labelRights_ [l=cs] {Práva}                      # opink 7.4.2011 - sl.
...
# Makra pro DLS - převzato ze sl. - 9.4.2009 18:02:40
# DLS metadata set
_textOrganization_ [l=cs] {Organizace}  # Updated 26-Mar-2007 by tomasfiala
_labelOrganization_ [l=cs] {Organizace} # Updated 26-Mar-2007 by tomasfiala
_textKeyword_ [l=cs] {Klíčové slovo}    # Updated 25-Aug-2006 by tomas
_textHowto_ [l=cs] {DLS: Způsob řešení} # Updated 26-Mar-2007 by tomasfiala, op 21.4.2009
# _labelHowto_ [l=cs, c=op0809b] {Jak}  # Updated 25-Aug-2006 by tomas
_labelHowto_ [l=cs] {DLS:Jak}           # Updated 25-Aug-2006 by tomas, op 21.4.2009
...
_textprefschanged_ [l=cs] {Nastavení byla změněna. Nepoužívejte tlačítka "zpět" - změna by se neprojevila! Použijte některé z tlačítek na našem navigačním panelu.
}
...
_textcollectionoption_ [l=cs] {<p>Subkolekce k zobrazení:<br>}  #opink 7.4.2011

_textsearchtype_ [l=cs] {Vyhledávací okno:}  #opink 7.4.2011
_textformsearchtype_ [l=cs] {formátovat podle _formnumfieldoption_ polí} #opink 7.4.2011  
_textplainsearchtype_ [l=cs] {_boxsizeoption_} #opink 7.4.2011 
_textregularbox_ [l=cs] {normální velikost}  #opink 7.4.2011
_textlargebox_ [l=cs] {velké}  #opink 7.4.2011
...
_textnohistorydisplay_ [l=cs] {nezobrazuj historii dotazů} #opink 7.4.2011
...
_textdefaulthelp_ [l=cs] {prohlížení dokumentů podle _1_, kliknutím na tlačítko _2_} # Vzor: sl, opink 7.4.2011

_textSearchhelp_ [l=cs] {hledání slov z textu, kliknutím na tlačítko _labelSearch_ } # Vzor: sl, opink 7.4.2011
_textTohelp_ [l=cs] {prohlížet dokumenty podle pole kliknutím na tlačítko _labelTo_ } # Vzor: sl, opink 7.4.2011 
_textFromhelp_ [l=cs] {prohlížet publikace podle _labelFrom_ } # Vzor: sl, opink 7.4.2011 
_textBrowsehelp_ [l=cs] {prohlížet dokumenty} # Vzor: sl, opink 7.4.2011  
_textAcronymhelp_ [l=cs] {zobrazit dokumenty podle výskytu zkratky _labelAcronym_ } # Vzor: sl, opink 7.4.2011  
_textPhrasehelp_ [l=cs] {prohlížet slovní spojení z dokumentu, kliknutím na tlačítko _labelPhrase_ .} # Vzor: sl, opink 7.4.2011 

_texthelptopicstitle_ [l=cs] {Témata} # Vzor: sl,  opink 7.4.2011 

_textreadingdocs_ [l=cs] {Jak číst dokumenty} # Vzor: sl, opink 7.4.2011
