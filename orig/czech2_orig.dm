...
# 28.5.2009 op - oprava makra pro externí odkazy href=
# 7.4.2010 op - je: href", má být href="
...
<p>
Odkaz, který jste zvolili je externí. Odkazuje na kolekci "_2_". Přejete-li si zobrazit dokument z kolece "_2_" můžete použít <a href="_httpdoc_&c_1_&cl_cgiargcl_&d_3_">tento odkaz</a>; v opačném případě použijte tlačítka "zpět" ve vašem prohlížeči.}
...
_textviewbildsummary_ [l=cs] {Můžete zobrazit<a href="_httppagex_(bsummary)&c_cgiargbc1dirname_" target_top>detailní zprávu</a> o tvorbě kolekce.}
...
_textdelperm_ [l=cs] {Některé z _cgiargbc1dirname_ kolekcí nemohly být smazány. Možné příčiny jsou:<ul>
<li>Greenstone nemá oprávnění mazat adresář _gsdlhome_/collect/_cgiargbc1dirname_.<br>
...
<ul>
<li>Kolekce _cgiargclonecol_ neexistuje</li>
<li>Kolekce _cgiargclonecol_ postrádá konfigurační soubor (collect.cfg)</li>
...
Chyba při exportu kolekce _cgiargbc1dirname_ .<p>
...
_textremwarn_ [l=cs] {Skutečně chcete zcela odstranit uživatele <b>_cgiargumun_</b>?}
